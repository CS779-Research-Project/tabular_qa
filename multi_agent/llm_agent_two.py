...
# Argument parser to allow passing LLM_NAME, AGENT_ONE_FOLDER, and AGENT_TWO_FOLDER as arguments
parser = argparse.ArgumentParser(description="Run question breakdown and validation with two agents.")
parser.add_argument('--llm_name', type=str, required=True, help='Name of the language model to be used')
parser.add_argument('--agent_one_folder', type=str, required=True, help='Folder where Agent One\'s output files are saved')
parser.add_argument('--agent_two_folder', type=str, required=True, help='Folder where Agent Two\'s output files will be saved')
args = parser.parse_args()

LLM_NAME = args.llm_name
AGENT_ONE_FOLDER = args.agent_one_folder
AGENT_TWO_FOLDER = args.agent_two_folder
...
TABLE_NUMBER = AGENT_ONE_FOLDER.split('_')[-1]
...
# Iterate through questions and process each one
print("Length of the filtered QA: ", len(filtered_qa)) 
