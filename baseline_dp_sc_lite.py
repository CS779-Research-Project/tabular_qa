...
for k, v in list(splits_q.items()):
    ...
    """
            ...
            results[k][i] = {"question": question, "model_answers": extracted_answers, "sample_answer" : row['sample_answer'], "answer": row['answer']}
...
with open('phi35_dp_sc_lite.json', 'w') as f:
    json.dump(results, f, indent=4)

with open('results/phi35_dp_sc_lite.pkl', 'wb') as f:
