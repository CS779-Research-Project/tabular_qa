...
def answer(df):
    {returns_string} 
            ...
            generate_ids = model.generate(inputs.input_ids, attention_mask=attention_mask, max_new_tokens=300)
...
with open('results_13b_code1_full.pkl', 'wb') as f:
